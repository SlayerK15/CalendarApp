...
export default function DashboardPage() {
  ...
  useEffect(() => {
    api<Dashboard>('dashboard').then(setData).catch(error => {
    ...
    api<Record<string, string[]>>('options').then(setOptions).catch(error => setError(error.message));
